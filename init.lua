...
require('lazy').setup({
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        pickers = {
          find_files = {
            hidden = true,
            file_ignore_patterns = { '%.git/', '%.venv/', '__pycache__/', 'node_modules/', '.docusaurus/' },
            no_ignore = true,
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      local parsers = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'go', 'yaml', 'json', 'python' }
